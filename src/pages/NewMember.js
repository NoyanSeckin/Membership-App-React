  ...
  return (
    <Box sx={containerStyle}>
     <Container maxWidth='xl'>
      {/* {renderForm()} */}
      <MainInfoForm initialValues={initialValues} yupObject={yupObject} inputInfos={inputInfos} formHeader={formHeader} btnText={btnText} radioLabel={radioLabel} submitAction={addMember}/>
     </Container>
    </Box>
  )
}
